import windowImg1 from "./Img/ImgProduct/ImgPageProduct/WindowImg1.jpg";
import windowImg2 from "./Img/ImgProduct/ImgPageProduct/WindowImg2.jpg";
import windowImg3 from "./Img/ImgProduct/ImgPageProduct/WindowImg3.jpg";

export const NewsData = [
  {
    coverImg: windowImg1,
    name: "DRUTEX receives the Superbrands title for the 7th time",
    date: new Date().toDateString(),
    header:
      "DRUTEX – one of European leaders of the window and door woodwork market – is among the strongest Polish brands, internationally recognized, the showcase of Polish enterprise. It is confirmed by the Superbrands title, given to the Bytów company for the seventh time.",
    text: [
  ...
  {
    coverImg: windowImg2,
    name: "DRUTEX receives the European Medal for aluminum doors",
    date: new Date().toDateString(),
    header:
  ...
  {
    coverImg: windowImg3,
    name: "Drutex yet again is the Golden Construction Brand of the Year.",
    date: new Date().toDateString(),
    header:
