...
export const ProductData = [
  ...
  },
  {
    ...
    options: {
      ...
      secondOption: [
        "Energy efficiency as a result of the optimal profile structure, specially designed sealing system made of foamed EPDM and glass packages with low thermal transmittance.",
        "Modern design that is guaranteed by the slim, round-shaped profiles.",
        "High safety level guaranteed by two anti-burglary bolts in standard.",
        "Wide range veneer colours that ensures numerous interior design styles.",
        "Good parameters of sound insulation that ensure acoustic comfort even in places with intense traffic.",
        "Great parameters of air permeability and water resistance as a result of using triple sealing.",
        "System offers great resistance to wind  load thanks to optimal reinforcement.",
      ...
      thirdOption: ["IGLO Light", "IGLO Energy", "IGLO 5", "IGLO 5 Classic"],
    },
    material: [
      "7-chamber frame and sash profiles made exclusively of prime material in A-class with installation depth 82 mm.",
      "Maximal glazing thickness up to 48 mm. Glass package  4/18/4/18/4 with thermal transmittance  Ug = 0,5 W/(m2K) in standard. Optionally – the possibility to apply four-glass package filled with krypton with  Ug = 0,3 W/(m2K); the possibility to apply glasses with enhanced sound insulation, tempered, safety, anti-burglary, ornament or solar protective",
      "MACO MULTI MATIC KS with two anti-burglary bolts in standard. Silber-Look coating and line-shaped concavities in espagnolette, optionally hinges hidden in the fitting notch; solutions in anti-burglary class RC 2 and RC 2N, window equipped with lifiting sash and handle missplacement blockage *, micro-ventilation in a slot **. ",
    ],
  },
  {
    ...
    options: {
      ...
      secondOption: [
        ...
        "High safety level guaranteed by two anti-burglary bolts in standard.",
        "Wide range veneer colours that enables numerous interior design styles.",
        "Very good thermal parameters that ensure heat saving thanks to optimal structure and the EPDM sealing. ",
        "Good parameters in sound insulation that guarantee acoustic comfort.",
      ],
      thirdOption: ["IGLO Energy", "IGLO Energy", "IGLO 5", "IGLO 5 Classic"],
    },
    material: [
  ...
  },
  {
    ...
    options: {
      firstOption:
        "Very good thermal insulation parameters in attractive price that allow to reduce heat losses in the flat.",
      secondOption: [
        "Design that reflects innovativeness and unconventionality.",
        "High safety level guaranteed by  two anti-burglary bolts in standard.",
        "Wide range veneer colours that enables numerous interior design styles.",
        "Very good thermal parameters that ensure heat saving as a result of optimal structure and the EPDM sealing.",
        "Good parameters in sound insulation that guarantee acoustic comfort.",
        "The possibility to execute in the so-called thin wielding technology (V-Perfect), that allows to connect the profiles perfectly and it guarantees better clamp and wielding control, and, as a result, very good parameters in the resistance tests of the corners.",
      ],
      thirdOption: ["IGLO Energy", "IGLO Energy", "IGLO Energy Classic", "IGLO 5"],
    },
    material: [
      "5-chamber profiles of the frame and the sash made exclusively of prime material in A-class with installation depth 70 mm.",
      "Glazing thickness up to 40 mm. One-chamber glass package with thermal transmittance coefficient Ug =1,0 W/(m2K) according to PN-EN674 in standard. The possibility to apply packages of Ug = 0,6 W/(m2K) coefficient. The possibility to apply glass with enhanced sound insulation, tempered, safety, anti-burglary, ornament, solar protective.",
      "MACO MULTI MATIC KS with two anti-burglary bolts in standard. Silber-Look coating and line-shaped concavities in espagnolette, optionally hinges hidden in the fitting notch; solutions in anti-burglary class RC 2 and RC 2N, window equipped with lifiting sash and handle missplacement blockage *, micro-ventilation in a slot **. ",
    ],
  },
  {
    ...
    options: {
      ...
      secondOption: [
        "Elegant design reflected in the beautiful form of the rounded profile with streamline shape of smooth, shiny sufrace. Windows are available in two types of wood: pine, meranti 450",
        ...
        "Long lasting woodwork thanks to the aluminium board that protects the wood against UV rays and water flowing from the glass with thermos-drip that facilitates water drainage",
        "Possibilty of free interior design with great selection of covering and transparent paints.",
        "High level of energy efficiency orovided by the optimum quality of materials used for production, special sealing system and the proper glass packages ",
      ],
      thirdOption: ["IGLO Energy", "IGLO Energy Classic", "IGLO 5", "IGLO 5 Classic"],
    },
    material: [
      "Drei unterschiedliche Einbautiefen zur Auswahl: 68 mm, 78 mm, 88 mm – in zwei Holzarten: drei- oder vierschichtenverklebtes massives Kiefer-, Merantikantholz 450+.",
      "Two-glass package of 24 mm thickness, with thermal transmittance coefficient of Ug=1,0 W/(m2K) according to PN-EN674 in standard. The possibility to apply two-, three- or four-glass packages. For Softline 68 mm – max. glass package is 32 mm with thermal transmittance coefficient of Ug = 0,8 W/(m2K). For Softline 78 mm – max. glass package is 44 mm with thermal transmittance coefficient of Ug = 0,6 W/(m2K). For Softline 88 mm – max. glass package is 54 mm with thermal transmittance coefficient of with three-glass package Ug = 0,5 W/(m2K) or Ug = 0,3 W/(m2K) with four-glass package with krypton. The possibility to apply glass with enhanced sound insulation, tempered, safety, anti-burglary, ornament, solar protective.",
      "Maco Multi Matic KS hardware with two anti-burglary bolts in standard. Window equipped with a blockage against handle misplacement and a sash lift *; micro-ventilation in a slot **; optionally application of hidden hinges",
    ],
  },
  {
